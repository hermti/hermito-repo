...
def starten():
	LogNotify('Packages Install',WIZLOG)
	log('Packages install gestartet')
...
def repoinstallall():
	LogNotify('Repo Install',WIZLOG)
	log('Repo Install All gestartet')
	xbmc.executebuiltin('InstallAddon(%s)' % ("script.hermito.aio"))
