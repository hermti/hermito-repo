...
from resources.libs import extract, downloader, notify, debridit, traktit, loginit, skinSwitch, uploadLog, yt, wizard as wiz, AddonsInstallieren
...
def maintMenu(view=None):
	...
	addFile('Alle Addons aus Repo installieren',    'repoinstallall',    icon=ICONMAINT, themeit=THEME3)
	addFile('Packages-ZIPs installieren und initiale Einstellungen setzen',    'packageinstall',    icon=ICONMAINT, themeit=THEME3)
